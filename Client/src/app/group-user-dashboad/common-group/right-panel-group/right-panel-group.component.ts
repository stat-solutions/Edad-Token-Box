...
@Component({
  selector: 'app-right-panel-group',
  templateUrl: './right-panel-group.component.html',
  styleUrls: ['./right-panel-group.component.scss']
})
export class RightPanelGroupComponent implements OnInit {
