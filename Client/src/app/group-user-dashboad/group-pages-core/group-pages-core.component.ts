...
@Component({
  selector: 'app-group-pages-core',
  templateUrl: './group-pages-core.component.html',
  styleUrls: ['./group-pages-core.component.scss']
})
export class GroupPagesCoreComponent implements OnInit {
