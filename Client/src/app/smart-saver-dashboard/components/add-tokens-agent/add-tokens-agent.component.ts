...
@Component({
  selector: 'app-add-tokens-agent',
  templateUrl: './add-tokens-agent.component.html',
  styleUrls: ['./add-tokens-agent.component.scss']
})
export class AddTokensAgentComponent implements OnInit {
