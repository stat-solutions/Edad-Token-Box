...
@Component({
  selector: 'app-withdraw-saver-profit',
  templateUrl: './withdraw-saver-profit.component.html',
  styleUrls: ['./withdraw-saver-profit.component.scss']
})
export class WithdrawSaverProfitComponent implements OnInit {
