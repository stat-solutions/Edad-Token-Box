...
@Component({
  ...
  templateUrl: './content-section-saver.component.html',
  styleUrls: ['./content-section-saver.component.scss']
})
export class ContentSectionSaverComponent implements OnInit {
