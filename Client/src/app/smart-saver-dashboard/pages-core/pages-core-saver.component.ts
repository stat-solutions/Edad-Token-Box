...
@Component({
  selector: 'app-pages-core-saver',
  templateUrl: './pages-core-saver.component.html',
  styleUrls: ['./pages-core-saver.component.scss']
})
export class PagesCoreSaverComponent implements OnInit {
  setNavLayout: string;
  themeLayout: string;
