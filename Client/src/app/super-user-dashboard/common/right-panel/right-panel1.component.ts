...
@Component({
  selector: 'app-right-panel1',
  templateUrl: './right-panel1.component.html',
  styleUrls: ['./right-panel1.component.scss'],
})
export class RightPanel1Component implements OnInit {
