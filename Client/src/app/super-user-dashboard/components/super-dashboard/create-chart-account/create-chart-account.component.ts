...
@Component({
  selector: 'app-create-chart-account',
  templateUrl: './create-chart-account.component.html',
  styleUrls: ['./create-chart-account.component.scss']
})
export class CreateChartAccountComponent implements OnInit {
  ...
  },
  {
    ...
    account_level_3X: 'CAPITAL'
        ...
        selectAccountLeve21Item(event: any) {
          ...
          this.fval. account_level_2X.setValue(event.target.value);
          this.fval. account_level_2.disable();

        }

        selectAccountLeve31Item(event: any) {

          // this.fval. account_level_3.enable();

          // this.accountLevel3 = this.accountLevel3.filter(theAccountLevel3 => theAccountLevel3.account_level_2X === event.target.value);

          this.fval. account_level_3X.setValue(event.target.value);

          this.fval. account_level_3.disable();
