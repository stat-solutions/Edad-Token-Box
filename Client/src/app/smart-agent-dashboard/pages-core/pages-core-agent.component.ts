...
@Component({
  selector: 'app-pages-core-agent',
  templateUrl: './pages-core-agent.component.html',
  styleUrls: ['./pages-core-agent.component.scss']
})
export class PagesCoreAgentComponent implements OnInit {
  setNavLayout: string;
  themeLayout: string;
