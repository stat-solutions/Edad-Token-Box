...
@Component({
  ...
  templateUrl: './content-section-agent.component.html',
  styleUrls: ['./content-section-agent.component.scss']
})
export class ContentSectionAgentComponent implements OnInit {
