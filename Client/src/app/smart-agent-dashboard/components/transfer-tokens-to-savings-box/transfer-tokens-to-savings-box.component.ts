...
@Component({
  selector: 'app-transfer-tokens-to-savings-box',
  templateUrl: './transfer-tokens-to-savings-box.component.html',
  styleUrls: ['./transfer-tokens-to-savings-box.component.scss']
})
export class TransferTokensToSavingsBoxComponent implements OnInit {
