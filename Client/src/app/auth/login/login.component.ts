...
export class LoginComponent implements OnInit {
    ...
    this.authService.testUserMoreUserRoles(event.target.value).subscribe(
      (roledata) => {
        if (roledata[0].roles > 1) {
          ...
          this.userRoleInfo1 = this.userRoleInfo1.filter(
            (theUserRoleD) => theUserRoleD.users_contact === event.target.value
          );
  ...
  setRoleId(event: any) {
    ...
    this.fval.user_role_id.setValue(
      this.userRoleInfo1.find(
        ...
        .subscribe(
          (success: boolean) => {
            ...
            if (jwt_decode(this.authService.getJwtToken()).user_role === 1000) {
              this.alertService.success({
                html:
                  "<strong>Signed In Successfully into Smart Saver's Token Box</strong>",
              });
              ...
              this.alertService.success({
                html:
                  "<strong>Signed In Successfully into Smart Agent's Token Box</strong>",
              });
              this.spinner.hide();
              setTimeout(() => {
                this.router.navigate([
                  "smartagent/dashboardAgent/theAgentDashboard",
                ]);
              }, 1000);
            } else if (
              ...
              this.alertService.success({
                html:
                  "<strong>Signed In Successfully into Smart Vendor's Token Box</strong>",
              });
              this.spinner.hide();
              ...
              this.alertService.success({
                html:
                  "<strong>Signed In Successfully into Group User's Token Box</strong>",
              });
              this.spinner.hide();

              setTimeout(() => {
                this.router.navigate(["smartgroup/dashboardgroup"]);
              }, 1000);
            } else if (
              ...
              this.alertService.success({
                html:
                  "<strong>Signed In Successfully into Box for God Token Box</strong>",
              });
              this.spinner.hide();
              ...
              this.alertService.success({
                html:
                  "<strong>Signed In Successfully into School Fees Token Box</strong>",
              });
              this.spinner.hide();
              ...
              if (
                jwt_decode(this.authService.getJwtToken()).approval_status === 1
              ) {
                this.alertService.danger({
                  html:
                ...
                jwt_decode(this.authService.getJwtToken()).approval_status === 2
              ) {
                this.alertService.success({
                  html:
                    "<strong>Signed In Successfully into Main Admin's  Box</strong>",
                });
                this.spinner.hide();

                setTimeout(() => {
                  this.router.navigate(["admindashboard/dashboardadmin"]);
                }, 1000);
              }
            } else if (
              ...
              this.alertService.success({
                html:
                  "<strong>Signed In Successfully into Super Users' Box</strong>",
              });
              this.spinner.hide();

              setTimeout(() => {
                this.router.navigate(["superuser/thesuperdashboard"]);
              }, 1000);
            } else {
              // this.alertService.danger({
