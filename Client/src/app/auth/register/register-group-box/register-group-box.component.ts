...
@Component({
  selector: "app-register-group-box",
  templateUrl: "./register-group-box.component.html",
  styleUrls: ["./register-group-box.component.scss"],
})
export class RegisterGroupBoxComponent implements OnInit {
  registered = false;
  submitted = false;
  errored = false;
  posted = false;
