...
@Component({
  selector: "app-register-box-for-god",
  templateUrl: "./register-box-for-god.component.html",
  styleUrls: ["./register-box-for-god.component.scss"],
})
export class RegisterBoxForGodComponent implements OnInit {
  registered = false;
  submitted = false;
  errored = false;
  posted = false;
    ...
    return this.fb.group(
      {
        ...
        nameBoxKeeper: new FormControl(
          "",
          Validators.compose([Validators.required])
        ),
        titleBoxKeeper: new FormControl(
          "",
          Validators.compose([Validators.required])
        ),
