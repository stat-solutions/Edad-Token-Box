...
@Component({
  selector: 'app-approve-token-withdraws',
  templateUrl: './approve-token-withdraws.component.html',
  styleUrls: ['./approve-token-withdraws.component.scss']
})
export class ApproveTokenWithdrawsComponent implements OnInit {
        ...
        // this.checkloans();
          ...
          approveTokens(customerId: string) {
            ...
            this.adminUserService.approveTokensAdminWithdraw(customerId).subscribe(
              data => {
          ...
          tokensApprovalDetails() {

            this.adminUserService.getAllDetailsOfTokenWithdrawApprovals().subscribe(
              data => {
